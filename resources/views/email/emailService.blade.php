                        ...
                        <td align="center" valign="top" style="padding: 40px 10px 10px 10px;">
                            <a href="#" target="_blank" style="text-decoration: none;">
                                <span
                                    ...
                                    border="0"><b style="color:#ff4c52">Star</b> Autocare</span>
                            </a>
                        </td>
                    </tr>
                </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">Please find attached below a copy of the job card and vehicle status.</p>
                        </td>
                    </tr>
                    <!-- COPY -->
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">Regards,<br>Star Autocare </p>
                        </td>
                    </tr>
                </table>
                <!--[if (gte mso 9)|(IE)]>
